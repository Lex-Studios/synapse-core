...
async fn setup_test_app() -> (String, PgPool, broadcast::Sender<TransactionStatusUpdate>, impl std::any::Any) {
...
async fn test_ws_connection_cleanup_on_disconnect() {
    ...
    assert_eq!(sent_count2, 0, "Should have 0 active subscribers after disconnect");
}
